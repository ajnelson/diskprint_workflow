...
An easier approach to running the workflow is telling it to run on all available sequences; to do this, pass the flag "`--parallel-all`" instead of a tarball path.
